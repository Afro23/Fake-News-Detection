...
logR_pipeline_ngram = Pipeline([
        ...
        ('LogR_clf',LogisticRegression(penalty="l2",C=1,max_iter=100))
        ])
...
pyfile = open("fmodel.py","w")
pyfile.write(logR_pipeline_ngram)
pyfile.close()
...
"""
Now let's extract the most informative feature from tfidf vectorizer for all fo the classifiers and see of there are any common
