...
logR_pipeline_ngram = Pipeline([
        ...
        ('LogR_clf',LogisticRegression(penalty="l2",C=1,max_iter=10500))
        ])
...
build_confusion_matrix(logR_pipeline_ngram,"Logistic Regression", "N-Gram")
...
pyfile = open("assets/models/fmodel.sav","w")
pickle.dump(logR_pipeline_ngram,open("fmodel.py",'wb'))
...
def plot_learing_curve(pipeline,title):
    ...
    plt.ylim(-.1,1.1)
    plt.tight_layout()
    plt.savefig('images/Naive-Bayes.png')
    plt.show()
